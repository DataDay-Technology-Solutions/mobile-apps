...
struct QuickFeature: Identifiable, Equatable {
    ...
    static let allFeatures: [QuickFeature] = [
        ...
        QuickFeature(id: "slips", title: "Permission Slips", icon: "signature", color: .cyan, badge: 2),
        QuickFeature(id: "calendar", title: "Calendar", icon: "calendar", color: .blue),
        QuickFeature(id: "mood", title: "Mood Check-In", icon: "face.smiling", color: .yellow),
...
struct TeacherHomeView: View {
    ...
    @State private var favoriteIds: Set<String> = ["picker", "slips", "calendar", "mood"]
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(spacing: 8) {
                PendingItemRow(
                    icon: "signature",
                    iconColor: .cyan,
                    title: "2 permission slips pending",
                    subtitle: "Zoo Field Trip - 3 days left"
                ) {
                    selectedFeature = QuickFeature.allFeatures.first { $0.id == "slips" }
                }
                ...
                PendingItemRow(
                    ...
                    subtitle: "Start today's mood check"
                ) {
                    selectedFeature = QuickFeature.allFeatures.first { $0.id == "mood" }
                }
            }
        }
        .padding()
        ...
        NavigationStack {
            List {
                ...
                Section("Recognition") {
                    ...
                    FeatureListRow(feature: QuickFeature.allFeatures[7], favoriteIds: $favoriteIds) {
                        selectedFeature = QuickFeature.allFeatures[7]
                        dismiss()
                    }
                }
                ...
                Section("Parent Engagement") {
                    ...
                    FeatureListRow(feature: QuickFeature.allFeatures[6], favoriteIds: $favoriteIds) {
                        selectedFeature = QuickFeature.allFeatures[6]
                        dismiss()
                    }
