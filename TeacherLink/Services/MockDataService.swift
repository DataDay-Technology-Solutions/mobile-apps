...
class MockDataService {
    ...
    let parentUsers: [User] = [
        User(id: "parent1", email: "jessica.martinez@email.com", name: "Jessica Martinez", displayName: "Jessica Martinez", role: .parent, classIds: ["class1"], createdAt: Date().addingTimeInterval(-86400 * 60)),
        User(id: "parent2", email: "mike.chen@email.com", name: "Mike Chen", displayName: "Mike Chen", role: .parent, classIds: ["class1"], createdAt: Date().addingTimeInterval(-86400 * 55)),
        User(id: "parent3", email: "sarah.williams@email.com", name: "Sarah Williams", displayName: "Sarah Williams", role: .parent, classIds: ["class1"], createdAt: Date().addingTimeInterval(-86400 * 50)),
        User(id: "parent4", email: "david.johnson@email.com", name: "David Johnson", displayName: "David Johnson", role: .parent, classIds: ["class1"], createdAt: Date().addingTimeInterval(-86400 * 45)),
        User(id: "parent5", email: "emily.thompson@email.com", name: "Emily Thompson", displayName: "Emily Thompson", role: .parent, classIds: ["class1"], createdAt: Date().addingTimeInterval(-86400 * 40))
    ]
    ...
    let students: [Student] = [
        Student(id: "s1", firstName: "Sofia", lastName: "Martinez", classId: "class1", parentIds: ["parent1"]),
        Student(id: "s2", firstName: "Ethan", lastName: "Chen", classId: "class1", parentIds: ["parent2"]),
        Student(id: "s3", firstName: "Olivia", lastName: "Williams", classId: "class1", parentIds: ["parent3"]),
        Student(id: "s4", firstName: "Jackson", lastName: "Johnson", classId: "class1", parentIds: ["parent4"]),
        Student(id: "s5", firstName: "Emma", lastName: "Thompson", classId: "class1", parentIds: ["parent5"]),
        Student(id: "s6", firstName: "Liam", lastName: "Garcia", classId: "class1", parentIds: []),
        Student(id: "s7", firstName: "Ava", lastName: "Rodriguez", classId: "class1", parentIds: []),
        Student(id: "s8", firstName: "Noah", lastName: "Lee", classId: "class1", parentIds: []),
        Student(id: "s9", firstName: "Isabella", lastName: "Brown", classId: "class1", parentIds: []),
        Student(id: "s10", firstName: "Mason", lastName: "Davis", classId: "class1", parentIds: []),
        Student(id: "s11", firstName: "Mia", lastName: "Wilson", classId: "class1", parentIds: []),
        Student(id: "s12", firstName: "Lucas", lastName: "Anderson", classId: "class1", parentIds: [])
    ]
    ...
    lazy var messages: [String: [Message]] = [
        ...
        "conv2": [
            ...
            Message(id: "m7", conversationId: "conv2", senderId: "teacher1", senderName: "Mrs. Koelpin", content: "Here's a photo of him reading to the class yesterday. He was so proud!", isRead: true, createdAt: Date().addingTimeInterval(-79200)),
        ...
        "conv4": [
            ...
            Message(id: "m15", conversationId: "conv4", senderId: "teacher1", senderName: "Mrs. Koelpin", content: "Perfect! Here's a preview of where we're going - the kids are so excited!", isRead: true, createdAt: Date().addingTimeInterval(-165600)),
        ...
        "conv5": [
            ...
            Message(id: "m19", conversationId: "conv5", senderId: "teacher1", senderName: "Mrs. Koelpin", content: "Here's the photo from her presentation today!", isRead: true, createdAt: Date().addingTimeInterval(-3600))
        ]
    ]
    ...
    lazy var albumPhotos: [AlbumPhoto] = [
        // Winter Art Album
        AlbumPhoto(id: "photo1", albumId: "album1", imageURL: "https://picsum.photos/seed/photo1/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 3)),
        AlbumPhoto(id: "photo2", albumId: "album1", imageURL: "https://picsum.photos/seed/photo2/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 3 + 1800)),
        AlbumPhoto(id: "photo3", albumId: "album1", imageURL: "https://picsum.photos/seed/photo3/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 3 + 3600)),

        // Museum Field Trip Album
        AlbumPhoto(id: "photo4", albumId: "album2", imageURL: "https://picsum.photos/seed/photo4/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 5)),
        AlbumPhoto(id: "photo5", albumId: "album2", imageURL: "https://picsum.photos/seed/photo5/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 5 + 1800)),
        AlbumPhoto(id: "photo6", albumId: "album2", imageURL: "https://picsum.photos/seed/photo6/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 5 + 3600)),
        AlbumPhoto(id: "photo7", albumId: "album2", imageURL: "https://picsum.photos/seed/photo7/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 5 + 5400)),

        // Science Experiments Album
        AlbumPhoto(id: "photo8", albumId: "album3", imageURL: "https://picsum.photos/seed/photo8/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 7)),
        AlbumPhoto(id: "photo9", albumId: "album3", imageURL: "https://picsum.photos/seed/photo9/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 7 + 1800)),

        // Reading Corner Album
        AlbumPhoto(id: "photo10", albumId: "album4", imageURL: "https://picsum.photos/seed/photo10/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 10)),
        AlbumPhoto(id: "photo11", albumId: "album4", imageURL: "https://picsum.photos/seed/photo11/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 10 + 1800)),

        // Celebrations Album
        AlbumPhoto(id: "photo12", albumId: "album5", imageURL: "https://picsum.photos/seed/photo12/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 15)),
        AlbumPhoto(id: "photo13", albumId: "album5", imageURL: "https://picsum.photos/seed/photo13/800/600", uploadedBy: "teacher1", uploadedByName: "Mrs. Koelpin", createdAt: Date().addingTimeInterval(-86400 * 20))
    ]
}
